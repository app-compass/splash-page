    ...
    <body>
        <div class="wrapper">
                ...
                <div class="app-content-bg">
                    <div class="app-content-container">
                        <section>
                            ...
                            <p>AppCompass was created by Plus 3 Interactive, a small development shop. To save our time and serve our diverse clients better, we needed one core system to build and manage complex web applications and multiple websites.</p>
                            <p>So we created AppCompass,  an open-source Laraval framework for building and managing applications – and associated websites - that use SQL databases.</p>
                        </section>
                        ...
                        <section>
                            <h2>And more...</h2>
                            <p>Other components we’ve built for AppCompass include <strong>Slingshot</strong> for auto deployment of apps, sites, etc;  our modern full-featured <strong>PilotCMS</strong>;  geographic information management with <strong>Geo</strong>;  and for convenience, <strong>Blogger</strong>.</p>
            ...
            <footer class="footer">
                ...
                <p class="copyright">&copy; 2017 Plus 3 Interactive, LLC All Rights Reserved</p>
            </footer><!-- footer -->
        </div><!-- wrapper -->  
